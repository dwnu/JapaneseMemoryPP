# Privacy Policy for JMemo - Japanese Memory Game
...
Gathered data may include, but maybe not limited to: country, device model, device system, given consent information, what screen did user visit, what element user clicked. Shared data can also include personally identifiable information like 'ip address', 'advertising id' and details about application crashes.
